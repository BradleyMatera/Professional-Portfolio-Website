...
// Validate ../../../app/skills-experience/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/skills-experience">> = Specific
  const handler = {} as typeof import("../../../app/skills-experience/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
